...
export const getRandomPreset = () => {
    ...
    return {
        ...
        shape: {
            ...
            lineAngle: getRandomValue(randomPresetRules.shape.lineAngle),
            lineAngleRand: getRandomValue(randomPresetRules.shape.lineAngleRand),
            lineRatio: getRandomValue(randomPresetRules.shape.lineRatio),
            lineRounded: getRandomValue(randomPresetRules.shape.lineRounded),
            lineRatioRand: getRandomValue(randomPresetRules.shape.lineRatioRand),
            lineLookToOn: getRandomValue(randomPresetRules.shape.lineLookToOn),
